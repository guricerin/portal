(() => {
  ...
  // deno:https://cdn.skypack.dev/-/react-icons@v4.6.0-Bj59ZOCt3FjwL3P5UFnc/dist=es2019,mode=imports/optimized/react-icons.js
  ...
  var iconContext = createCommonjsModule4(function(module, exports) {
    ...
    exports.IconContext = react_default.createContext && react_default.createContext(exports.DefaultContext);
  });
  var iconBase = createCommonjsModule4(function(module, exports) {
    ...
    function Tree2Element(tree) {
      return tree && tree.map(function(node, i) {
        return react_default.createElement(node.tag, __assign({ key: i }, node.attr), Tree2Element(node.child));
      });
    }
    function GenIcon2(data) {
      return function(props) {
        return react_default.createElement(IconBase2, __assign({ attr: __assign({}, data.attr) }, props), Tree2Element(data.child));
      };
    }
    ...
    function IconBase2(props) {
      var elem = function(conf) {
        ...
        return react_default.createElement("svg", __assign({ stroke: "currentColor", fill: "currentColor", strokeWidth: "0" }, conf.attr, attr, svgProps, { className, style: __assign(__assign({ color: props.color || conf.color }, conf.style), props.style), height: computedSize, width: computedSize, xmlns: "http://www.w3.org/2000/svg" }), title && react_default.createElement("title", null, title), props.children);
      };
      return iconContext.IconContext !== void 0 ? react_default.createElement(iconContext.IconContext.Consumer, null, function(conf) {
        return elem(conf);
      }) : elem(iconContext.DefaultContext);
    }
    exports.IconBase = IconBase2;
  });
  var cjs = createCommonjsModule4(function(module, exports) {
  ...
  var DefaultContext = cjs.DefaultContext;
  var GenIcon = cjs.GenIcon;
  var IconBase = cjs.IconBase;
  var IconContext = cjs.IconContext;
  var IconsManifest$1 = cjs.IconsManifest;

  // deno:https://cdn.skypack.dev/-/react-icons@v4.6.0-Bj59ZOCt3FjwL3P5UFnc/dist=es2019,mode=imports/unoptimized/fa/index.esm.js
  ...
  // deno:file:///home/runner/work/portal/portal/src/components/Avator.tsx
  function Avator({ icon, name }) {
    return /* @__PURE__ */ react_default.createElement("div", {
      className: "avator"
    }, /* @__PURE__ */ react_default.createElement("img", {
      src: icon
    }), /* @__PURE__ */ react_default.createElement("span", null, name));
  }

  // deno:file:///home/runner/work/portal/portal/src/components/Header.tsx
  function Header({ text }) {
    return /* @__PURE__ */ react_default.createElement("div", null, /* @__PURE__ */ react_default.createElement("div", {
      className: "subtitle"
    }, /* @__PURE__ */ react_default.createElement("span", null, text)));
  }

  // deno:file:///home/runner/work/portal/portal/src/components/Accounts.tsx
  function Account(props) {
    ...
    }, props.icon, /* @__PURE__ */ react_default.createElement("span", null, props.name)));
  }
  function Accounts() {
    return /* @__PURE__ */ react_default.createElement("div", {
      className: "section"
      ...
      icon: /* @__PURE__ */ react_default.createElement(FaKeybase, null),
      name: "Keybase",
      url: "https://keybase.io/guricerin"
    }), /* @__PURE__ */ react_default.createElement(Account, {
      icon: /* @__PURE__ */ react_default.createElement(FaGithub, null),
      name: "GitHub",
  ...
  // deno:file:///home/runner/work/portal/portal/src/components/Works.tsx
  function Work(props) {
    return /* @__PURE__ */ react_default.createElement("div", {
      className: "icon-container"
    }, /* @__PURE__ */ react_default.createElement("a", {
  ...
  function Works() {
    return /* @__PURE__ */ react_default.createElement("div", {
      ...
      className: ""
    }, /* @__PURE__ */ react_default.createElement(Work, {
      icon: /* @__PURE__ */ react_default.createElement(FaBlog, null),
      name: "Blog",
      url: "https://guricerin.github.io/shit-blog/"
    }), /* @__PURE__ */ react_default.createElement(Work, {
      icon: /* @__PURE__ */ react_default.createElement(FaCode, null),
      name: "bf-derivatives-tool",
      url: "https://github.com/guricerin/bf-derivatives-tool"
    })));
  }

  // deno:file:///home/runner/work/portal/portal/src/App.tsx
  var avator = {
    icon: "avator.jpg",
    name: "guricerin"
  };
  function App() {
    return /* @__PURE__ */ react_default.createElement("div", {
      ...
      className: "inner"
    }, /* @__PURE__ */ react_default.createElement(Avator, {
      ...avator
    }), /* @__PURE__ */ react_default.createElement(Accounts, null), /* @__PURE__ */ react_default.createElement(Works, null)));
  }

  // deno:file:///home/runner/work/portal/portal/src/main.tsx
  function main() {
